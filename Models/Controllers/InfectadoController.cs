...
namespace Api.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        public ActionResult AtualizarInfectados([FromBody] InfectadoDto dto)
        {
            ...
            _infectadosCollection.UpdateOne(Builders<Infectado>.Filter.Where(_ => _.DataNascimento == dto.DataNascimento), Builders<Infectado>.Update.Set("sexo", infectado.Sexo));
